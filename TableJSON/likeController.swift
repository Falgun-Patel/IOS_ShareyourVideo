...
class likeController: UIViewController,UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "like", for: indexPath) as! likeCell
        
        cell.lblFoodName?.text = self.articles[indexPath.item].headline
        cell.lblDescription?.text = self.articles[indexPath.item].file
        
        cell.imageViewFood?.downloadImagel(from: (self.articles[indexPath.item].imageUrl!))
...
extension UIImageView {
    ...
    func downloadImagel(from url: String){
