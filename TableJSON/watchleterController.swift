...
class watchleterController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "watch", for: indexPath) as! watchleterCell
        
        cell.lblFoodName?.text = self.articles[indexPath.item].headline
        cell.lblDescription?.text = self.articles[indexPath.item].file
        
        cell.imageViewFood?.downloadImagehd(from: (self.articles[indexPath.item].imageUrl!))
...
extension UIImageView {
    ...
    func downloadImagehd(from url: String){
